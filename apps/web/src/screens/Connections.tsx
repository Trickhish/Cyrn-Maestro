 ...
 *
 * Three kinds, and the distinction is worth keeping visible: machines that run
 * the work, providers that supply the thinking, and MCP servers that reach
 * systems outside. They were previously all called "Fleet", which described
 * only the first. */

export type ConnectionsTab = "nodes" | "providers" | "mcp";
